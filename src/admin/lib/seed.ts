...
export const CATEGORIAS = [
  "Castillo", "Castillo con rampa", "Gigante", "Carrera de obstáculos", "Acuático",
...
const SEED_INFLABLES: SeedInf[] = [
  // Castillos
  { nombre: "Hombre Araña", cat: "Castillo", ancho: 4, largo: 5, alto: 2.5,
  ...
  { nombre: "Princesas", cat: "Castillo", ancho: 3, largo: 4, alto: 2.5,
  ...
  { nombre: "Castillo 3x6", cat: "Castillo", ancho: 3, largo: 6, alto: 2.8,
  ...
  { nombre: "Castillo 4x5", cat: "Castillo", ancho: 4, largo: 5, alto: 2.5,
  ...
  { nombre: "Castillo 2x2", cat: "Castillo", ancho: 2, largo: 2, alto: 2,
  ...
  // Gigantes
  { nombre: "Demoledor", cat: "Gigante", ancho: 6, largo: 8, alto: 3.5,
  ...
  { nombre: "Arcoíris", cat: "Gigante", ancho: 5, largo: 7, alto: 3.2,
  ...
  { nombre: "Barco Pirata", cat: "Gigante", ancho: 4, largo: 6, alto: 3,
  ...
  { nombre: "Carrera de obstáculos", cat: "Carrera de obstáculos", ancho: 6, largo: 10, alto: 3.5,
  ...
  // Acuáticos
  { nombre: "Deslizador", cat: "Acuático", ancho: 3, largo: 8, alto: 2.5,
  ...
  { nombre: "Rampa acuática arco", cat: "Acuático", ancho: 4, largo: 10, alto: 3,
  ...
  { nombre: "Rampa acuática", cat: "Acuático", ancho: 3, largo: 8, alto: 2.5,
  ...
  { nombre: "Tobogán acuático", cat: "Acuático", ancho: 4, largo: 9, alto: 3.2,
  ...
  // Juegos de salón
  { nombre: "Metegol", cat: "Juego de salón", ancho: 1.2, largo: 2, alto: 0.9,
  ...
  { nombre: "Tejo", cat: "Juego de salón", ancho: 1.5, largo: 1.5, alto: 0.8,
  ...
  { nombre: "Sapo", cat: "Juego de salón", ancho: 1, largo: 1.5, alto: 1,
  ...
  { nombre: "Pool", cat: "Juego de salón", ancho: 2, largo: 1, alto: 0.8,
  ...
  { nombre: "Ping pong", cat: "Juego de salón", ancho: 2.7, largo: 1.5, alto: 0.8,
  ...
  { nombre: "Yenga", cat: "Juego de salón", ancho: 0.5, largo: 0.5, alto: 1.5,
