...
export function seedArticulos(): Articulo[] {
  return SEED_ARTICULOS.map((b, i) => ({
    id: uid(),
    nombre: b.nombre,
    cat: b.cat,
    precio: 0,
...
export function reservasEjemplo(articulos: Articulo[]): Reserva[] {
  const ids = articulos.map((a) => a.id);
  const hoy = hoyStr();
  const base = [
    { fecha: addDias(hoy, 2), estado: "Señado", cliente: "Ejemplo — Caro", telefono: "11 5555-0001", zona: "Grand Bourg", direccion: "Av. Siempreviva 742", horaEntrega: "10:00", horaRetiro: "19:00", articuloIds: [ids[0]], precio: 45000, sena: 15000, notas: "Dato de ejemplo" },
    { fecha: addDias(hoy, 2), estado: "Reservado", cliente: "Ejemplo — Damián", telefono: "11 5555-0002", zona: "Tortuguitas", direccion: "Los Ceibos 120", horaEntrega: "11:00", horaRetiro: "18:00", articuloIds: [ids[1], ids[4]], precio: 78000, sena: 20000, notas: "Dato de ejemplo · salón techado" },
    { fecha: addDias(hoy, 5), estado: "Consulta", cliente: "Ejemplo — Vane", telefono: "11 5555-0003", zona: "Del Viso", articuloIds: [ids[3]], precio: 0, sena: 0, notas: "Dato de ejemplo · pregunta por acuático" },
    { fecha: addDias(hoy, 9), estado: "Reservado", cliente: "Ejemplo — Marcos", telefono: "11 5555-0004", zona: "Pilar", direccion: "B° Los Álamos", horaEntrega: "12:00", horaRetiro: "20:00", articuloIds: [ids[0]], precio: 52000, sena: 0, notas: "Dato de ejemplo" },
    { fecha: addDias(hoy, -6), estado: "Finalizado", cliente: "Ejemplo — Sole", telefono: "11 5555-0005", zona: "Escobar", articuloIds: [ids[2]], precio: 60000, sena: 60000, horaEntrega: "10:30", horaRetiro: "19:30", notas: "Dato de ejemplo" },
  ];
  return base.map((r) => ({
    horaEntrega: "",
    horaRetiro: "",
